...
function exportCSV() {
  ...
  const headers = ['เลขที่เอกสาร', 'คลังสินค้า', 'สาขา', 'ประเภทงาน', 'จำนวนขาด', 'จำนวนเกิน', 'จำนวนปัญหารวม', 'สาเหตุของ R008'];
  ...
  a.download = `R008_Export_${new Date().toISOString().slice(0, 10)}.csv`;
  a.click();
}
